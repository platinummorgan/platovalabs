  ...
  return (
    <Link href="/" aria-label="Platova Labs home" className={`inline-flex items-center gap-3 ${className}`}>
      <svg width="40" height="40" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
        ...
        <path d="M20 36c0-8 8-12 16-12v4c-6 0-12 2-12 8 0 6 6 8 12 8v4c-8 0-16-4-16-12z" fill="white" opacity="0.95" />
        <defs>
      ...
      <span className="hidden sm:inline-block font-semibold text-lg">Platova Labs</span>
    </Link>
  );
}
